...
*/
  ...
  {0,15,26}, {0,14,26}, {0,13,26}, {0,12,26}, {0,11,26}, {0,10,26}, {0,9,26}, {0,8,26}, {0,7,26}, {0,6,26}, {0,5,26}, {0,4,26}, {0,3,26}, {0,2,26}, {0,1,26}, {0,0,26},

  // Left edge
  {0,0,25}, {0,0,24}, {0,0,23}, {0,0,22}, {0,0,21}, {0,0,20}, {0,0,19}, {0,0,18}, {0,0,17}, {0,0,16}, {0,0,15}, {0,0,14}, {0,0,13}, {0,0,12}, {0,0,11}, {0,0,10}, {0,0,9}, {0,0,8}, {0,0,7}, {0,0,6}, {0,0,5}, {0,0,4}, {0,0,3}, {0,0,2}, {0,0,1},
  ...
  // Right edge
  {0,45,1}, {0,45,2}, {0,45,3}, {0,45,4}, {0,45,5}, {0,45,6}, {0,45,7}, {0,45,8}, {0,45,9}, {0,45,10}, {0,45,11}, {0,45,12}, {0,45,13}, {0,45,14}, {0,45,15}, {0,45,16}, {0,45,17}, {0,45,18}, {0,45,19}, {0,45,20}, {0,45,21}, {0,45,22}, {0,45,23}, {0,45,24}, {0,45,25},

  // Bottom edge, right half
  {0,45,26}, {0,44,26}, {0,43,26}, {0,42,26}, {0,41,26}, {0,40,26}, {0,39,26}, {0,38,26}, {0,37,26}, {0,36,26}, {0,35,26}, {0,34,26}, {0,33,26}, {0,32,26}, {0,31,26}, {0,30,26}
